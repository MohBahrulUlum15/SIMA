...
public class PompaDosingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerBarang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isSelected) {
                    ...
                    Toast.makeText(PompaDosingActivity.this, "Pilih barang", Toast.LENGTH_SHORT).show();
                    isSelected = false;
                }
            }
        ...
        asetViewModel.getNamaAset(new Callback<List<Barang>>() {
            ...
            public void onResponse(Call<List<Barang>> call, Response<List<Barang>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(PompaDosingActivity.this, "Gagal menampilkan nama barang", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Barang>> call, Throwable t) {
                Toast.makeText(PompaDosingActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.actionSimpan.setOnClickListener(view -> {
            ...
            String head_pompa = binding.etHeadPompaDosing.getText().toString();
            String debit_pompa = binding.etDebitPompaDosing.getText().toString();
            String jenis_pompa = "pompa dosing";
            ...
            if (tanggal.isEmpty()) {
                ...
                binding.etHeadPompaDosing.setError("belum diisi!");
            } else if (debit_pompa.isEmpty()) {
                binding.etDebitPompaDosing.setError("belum diisi!");
            } else {
                    ...
                    public void onResponse(Call<TambahPompaResponse> call, Response<TambahPompaResponse> response) {
                        if (response.isSuccessful()) {
                            ...
                            if (tambahPompaResponse.isSuccess()) {
                                Toast.makeText(PompaDosingActivity.this, tambahPompaResponse.getMessage(), Toast.LENGTH_SHORT).show();
                                binding.etTanggal.setText("");
                                binding.etNamaBarang.setText("");
                                binding.etHeadPompaDosing.setText("");
                                binding.etDebitPompaDosing.setText("");
                                startActivity(new Intent(PompaDosingActivity.this, MainActivity.class));
                                finish();
                            } else {
                                Toast.makeText(PompaDosingActivity.this, tambahPompaResponse.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(PompaDosingActivity.this, "Gagal!", Toast.LENGTH_SHORT).show();
                        }
                    }
